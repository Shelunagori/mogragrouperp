...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption" >
            ...
            <span class="caption-subject font-blue-steel uppercase">Add Non Print Payment</span>
        </div>
    </div>
        ...
        <table width="100%" id="main_table">
            ...
            <tfoot>
                ...
                <td>
					...
					<?php } else { ?>
					<button type="submit" class="btn btn-primary" id='submitbtn' >CREATE NON PRINT PAYMENT VOUCHER</button>
					<?php } ?>	
				</td>
                <td></td>
            </tfoot>
    ...
    function rename_ref_rows(sel,received_from_id){
        ...
        $(sel).find("table.ref_table tbody tr").each(function(){
            ...
            if(is_select){
                ...
                var url='<?php echo $this->Url->build(['controller'=>'nppayments','action'=>'checkRefNumberUnique']); ?>';
