        ...
        <table width="100%" id="main_table">
            ...
            <?php foreach($pettycashvoucher->petty_cash_voucher_rows as $petty_cash_voucher_row){ ?> 
                <tr class="main_tr" old_received_from_id="<?php echo $petty_cash_voucher_row->received_from_id; ?>">
                    <td><?php echo $this->Form->input('received_from_id', ['empty'=>'--Select-','options'=>$receivedFroms,'label' => false,'class' => 'form-control input-sm received_from','value'=>$petty_cash_voucher_row->received_from_id]); ?></td>
                    <td>
                    <div class="row">
