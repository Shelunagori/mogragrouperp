			...
			<table  class="table tableitm" id="main_tb" border="1">
				...
				<tfoot><?php 
					...
					<tr>
						...
						<td align="right" ><?php echo $this->Form->input('fright_ledger_account', ['empty' => "--Fright Account--",'label' => false,'options' =>$ledger_account_details_for_fright,'class' => 'form-control input-sm']); ?></td>
