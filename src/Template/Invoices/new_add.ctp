				...
				if(!empty($sales_order->sales_order_rows)){
					...
					?>
						<tr class="tr1  firsttr " row_no='<?php echo @$sales_order_rows->id; ?>'>
							...
							<td>
								<?php echo $this->Form->input('q', ['label' => false,'type' => 'text','value' => @$sales_order_rows->item->name,'readonly']); ?>
							...
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox discount_percentage','placeholder'=>'%','step'=>0.01]); ?></td>
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox','placeholder'=>'Amount','readonly','step'=>0.01]); ?></td>
							...
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox cgst_percentage','placeholder'=>'%','step'=>0.01]); ?></td>
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox','placeholder'=>'Amount','readonly','step'=>0.01]); ?></td>
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox sgst_percentage','placeholder'=>'%','step'=>0.01]); ?></td>
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox','placeholder'=>'Amount','readonly','step'=>0.01]); ?></td>
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox igst_percentage','placeholder'=>'%','step'=>0.01]); ?></td>
							<td><?php echo $this->Form->input('q', ['label' => false,'class' => 'form-control input-sm row_textbox','placeholder'=>'Amount','readonly','step'=>0.01]); ?></td>
...
$(document).ready(function() { 
	...
	$('.cgst_percentage').die().live("keyup",function() {
		var qty =$(this).val();
		rename_rows(); calculate_total();
    });
	
	$('.sgst_percentage').die().live("keyup",function() {
		var qty =$(this).val();
		rename_rows(); calculate_total();
    });
	$('.igst_percentage').die().live("keyup",function() {
		var qty =$(this).val();
		rename_rows(); calculate_total();
    });
	...
	function rename_rows(){
		...
		$("#main_tb tbody tr.tr1").each(function(){  
			...
			if(val){ 
				...
				$(this).find('td:nth-child(11) input').attr("name","invoice_rows["+val+"][cgst_percentage]").removeAttr("readonly").attr("id","q"+val).attr("id","invoice_rows-"+val+"-cgst_percentage").rules("add", "required");
				...
				$(this).find('td:nth-child(13) input').attr("name","invoice_rows["+val+"][sgst_percentage]").removeAttr("readonly").attr("id","q"+val).attr("id","invoice_rows-"+val+"-sgst_percentage").rules("add", "required");
				...
				$(this).find('td:nth-child(15) input').attr("name","invoice_rows["+val+"][igst_percentage]").removeAttr("readonly").attr("id","q"+val).attr("id","invoice_rows-"+val+"-igst_percentage").rules("add", "required");
				...
				$(this).find('td:nth-child(11) input').attr({ name:"q", readonly:"readonly"}).rules( "remove", "required" );
				$(this).find('td:nth-child(12) input').attr({ name:"q", readonly:"readonly"}).rules( "remove", "required" );
				$(this).find('td:nth-child(13) input').attr({ name:"q", readonly:"readonly"}).rules( "remove", "required" );
				$(this).find('td:nth-child(14) input').attr({ name:"q", readonly:"readonly"}).rules( "remove", "required" );
				$(this).find('td:nth-child(15) input').attr({ name:"q", readonly:"readonly"}).rules( "remove", "required" );
	...
	function calculate_total(){
		...
		$("#main_tb tbody tr.tr1").each(function(){
			...
			if(val){
				...
				var cgst_percentage=parseFloat($(this).find("td:nth-child(11) input").val());
				...
				var sgst_percentage=parseFloat($(this).find("td:nth-child(13) input").val());
				...
				var igst_percentage=parseFloat($(this).find("td:nth-child(15) input").val());
			...
			grand_total=grand_total+fright_amount;
