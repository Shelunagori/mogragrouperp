...
<div class="portlet light bordered ">
	...
	<div class="portlet-body form">
        			...
        			<legend>Sales-Order</b></legend>
 					<div class="checkbox-list">
						...
						<label class="checkbox-inline">
							...
							echo $this->Form->input('user_rights.151.page_id', ['label' => 'Gst Sales Order Add','class' => '','type'=>'checkbox','value'=>151,$checked_status]); ?>
						</label>
					</div>
					</fieldset>
				</div>
				...
				<div class="col-md-6">
					...
					<div class="checkbox-list">
						...
						<label class="checkbox-inline">
							...
							echo $this->Form->input('user_rights.10.page_id', ['label' => 'View','class' => '','type'=>'checkbox','value'=>10,$checked_status]); ?>
						</label>
					</div>
					</fieldset>
				</div>
        ...
        <legend>Report</b></legend>
				...
				<div class="col-md-3">
					<div class="titletext"><b>Stock Ledger</b></div>
						<div class="checkbox-list">
							<label class="checkbox-inline">
								<?php 
								if(in_array(150,$page_ids)){ $checked_status='checked'; }else{ $checked_status=''; }
								echo $this->Form->input('user_rights.150.page_id', ['label' => 'View','class' => '','type'=>'checkbox','value'=>150,$checked_status]); ?>
							</label>
						</div>
				</div>
				<div class="col-md-3">
					...
					<div class="titletext"><b>User Logs Report</b></div>
						<div class="checkbox-list">
							<label class="checkbox-inline">
								...
								echo $this->Form->input('user_rights.149.page_id', ['label' => 'View','class' => '','type'=>'checkbox','value'=>149,$checked_status]); ?>
							</label>
						</div>
				</div>
				<div class="col-md-4">
