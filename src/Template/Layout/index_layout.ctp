			...
			<ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="false" data-slide-speed="200">
				...
				<li>
					...
					<li>
						...
						<li><?php echo $this->Html->link('<i class="fa fa-truck"></i> Stock Report','/Item-Ledgers/Stock-Report?stockstatus=Positive',array('escape'=>false)); ?></li>	
						...
						<li><?php echo $this->Html->link('<i class="fa fa-truck"></i> Material Indent Report','/Item-Ledgers/material-indent-report?company_name=&company_name%5B%5D='.$st_company_id,array('escape'=>false)); ?></li>
						<?php } ?>
